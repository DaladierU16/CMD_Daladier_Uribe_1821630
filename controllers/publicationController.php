...
class publicationController extends publication{
    ...
    public function update(){
        echo parent::update_register($_POST) ? header('location:?controller=publication') : 'Error ';
    }


    //
    public function delete(){
        echo parent::delete_register($_GET['id']) ? header('location:?controller=publication') : 'Error ';
